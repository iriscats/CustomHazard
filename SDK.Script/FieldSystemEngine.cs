...
namespace SDK.Script.FieldSystemEngineSDK
{
    ...
    public class FieldSystemMetaDataFilter : FieldSystemMetaData
    {
        ...
        public FieldSystemMetaDataFilter SetMetaDataFilterType(byte FilterType) { return Invoke<FieldSystemMetaDataFilter>(nameof(SetMetaDataFilterType), FilterType); }
    }
