...
namespace SDK.Script.AudioMixerSDK
{
    ...
    public class QuartzClockHandle : Object
    {
        ...
        public QuartzSubsystem QuartzSubsystem { get { return this[nameof(QuartzSubsystem)].As<QuartzSubsystem>(); } set { this["QuartzSubsystem"] = value; } }
        public World WorldPtr { get { return this[nameof(WorldPtr)].As<World>(); } set { this["WorldPtr"] = value; } }
    ...
    public enum EQuarztClockManagerType : int
    {
        AudioEngine = 0,
        QuartzSubsystem = 1,
        Count = 2,
