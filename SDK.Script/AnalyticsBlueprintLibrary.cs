...
namespace SDK.Script.AnalyticsBlueprintLibrarySDK
{
    ...
    {
        public AnalyticsBlueprintLibrary(nint addr) : base(addr) { }
        public bool StartSessionWithAttributes(UArray<AnalyticsEventAttr> Attributes) { return Invoke<bool>(nameof(StartSessionWithAttributes), Attributes); }
        ...
        public void RecordSimpleItemPurchaseWithAttributes(Object ItemID, int ItemQuantity, UArray<AnalyticsEventAttr> Attributes) { Invoke(nameof(RecordSimpleItemPurchaseWithAttributes), ItemID, ItemQuantity, Attributes); }
        ...
        public void RecordSimpleCurrencyPurchaseWithAttributes(Object GameCurrencyType, int GameCurrencyAmount, UArray<AnalyticsEventAttr> Attributes) { Invoke(nameof(RecordSimpleCurrencyPurchaseWithAttributes), GameCurrencyType, GameCurrencyAmount, Attributes); }
        ...
        public void RecordProgressWithFullHierarchyAndAttributes(Object ProgressType, UArray<Object> ProgressNames, UArray<AnalyticsEventAttr> Attributes) { Invoke(nameof(RecordProgressWithFullHierarchyAndAttributes), ProgressType, ProgressNames, Attributes); }
        public void RecordProgressWithAttributes(Object ProgressType, Object ProgressName, UArray<AnalyticsEventAttr> Attributes) { Invoke(nameof(RecordProgressWithAttributes), ProgressType, ProgressName, Attributes); }
        ...
        public void RecordEventWithAttributes(Object EventName, UArray<AnalyticsEventAttr> Attributes) { Invoke(nameof(RecordEventWithAttributes), EventName, Attributes); }
        ...
        public void RecordErrorWithAttributes(Object Error, UArray<AnalyticsEventAttr> Attributes) { Invoke(nameof(RecordErrorWithAttributes), Error, Attributes); }
        ...
        public void RecordCurrencyGivenWithAttributes(Object GameCurrencyType, int GameCurrencyAmount, UArray<AnalyticsEventAttr> Attributes) { Invoke(nameof(RecordCurrencyGivenWithAttributes), GameCurrencyType, GameCurrencyAmount, Attributes); }
    ...
    {
        public AnalyticsEventAttr(nint addr) : base(addr) { }
