...
namespace SDK.Script.TimeSynthSDK
{
    ...
    {
        public TimeSynthVolumeGroup(nint addr) : base(addr) { }
    ...
    {
        public TimeSynthEnvelopeFollowerSettings(nint addr) : base(addr) { }
    ...
    {
        public TimeSynthFilterSettings(nint addr) : base(addr) { }
    ...
    {
        public TimeSynthClipSound(nint addr) : base(addr) { }
    ...
    {
        public TimeSynthClipHandle(nint addr) : base(addr) { }
    ...
    {
        public TimeSynthTimeDef(nint addr) : base(addr) { }
    ...
    {
        public TimeSynthQuantizationSettings(nint addr) : base(addr) { }
    ...
    {
        public TimeSynthSpectralData(nint addr) : base(addr) { }
