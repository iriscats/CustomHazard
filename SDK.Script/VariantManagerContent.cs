...
namespace SDK.Script.VariantManagerContentSDK
{
    public class LevelVariantSets : Object
    {
        ...
        public UArray<VariantSet> VariantSets { get { return new UArray<VariantSet>(this[nameof(VariantSets)].Address); } }
    ...
    public class PropertyValue : Object
    {
        ...
        public UArray<Object> Properties { get { return new UArray<Object>(this[nameof(Properties)].Address); } }
        public UArray<int> PropertyIndices { get { return new UArray<int>(this[nameof(PropertyIndices)].Address); } }
        public UArray<CapturedPropSegment> CapturedPropSegments { get { return new UArray<CapturedPropSegment>(this[nameof(CapturedPropSegments)].Address); } }
        ...
        public UArray<byte> ValueBytes { get { return new UArray<byte>(this[nameof(ValueBytes)].Address); } }
    ...
    public class SwitchActor : Actor
    {
        ...
        public UArray<Actor> GetOptions() { return Invoke<UArray<Actor>>(nameof(GetOptions)); }
    }
    public class Variant : Object
    {
        public Variant(nint addr) : base(addr) { }
        public UArray<VariantDependency> Dependencies { get { return new UArray<VariantDependency>(this[nameof(Dependencies)].Address); } }
        public Object DisplayText { get { return this[nameof(DisplayText)]; } set { this[nameof(DisplayText)] = value; } }
        public UArray<VariantObjectBinding> ObjectBindings { get { return new UArray<VariantObjectBinding>(this[nameof(ObjectBindings)].Address); } }
        ...
        public UArray<Variant> GetDependents(LevelVariantSets LevelVariantSets, bool bOnlyEnabledDependencies) { return Invoke<UArray<Variant>>(nameof(GetDependents), LevelVariantSets, bOnlyEnabledDependencies); }
    ...
    public class VariantObjectBinding : Object
    {
        ...
        public UArray<PropertyValue> CapturedProperties { get { return new UArray<PropertyValue>(this[nameof(CapturedProperties)].Address); } }
        public UArray<FunctionCaller> FunctionCallers { get { return new UArray<FunctionCaller>(this[nameof(FunctionCallers)].Address); } }
    }
    public class VariantSet : Object
    {
        ...
        public UArray<Variant> Variants { get { return new UArray<Variant>(this[nameof(Variants)].Address); } }
        public Texture2D Thumbnail { get { return this[nameof(Thumbnail)].As<Texture2D>(); } set { this["Thumbnail"] = value; } }
        public void SetThumbnailFromTexture(Texture2D NewThumbnail) { Invoke(nameof(SetThumbnailFromTexture), NewThumbnail); }
        public void SetThumbnailFromFile(Object FilePath) { Invoke(nameof(SetThumbnailFromFile), FilePath); }
        public void SetThumbnailFromEditorViewport() { Invoke(nameof(SetThumbnailFromEditorViewport)); }
