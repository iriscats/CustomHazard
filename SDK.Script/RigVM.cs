...
namespace SDK.Script.RigVMSDK
{
    public class RigVM : Object
    {
        ...
        public RigVMMemoryContainer WorkMemoryStorage { get { return this[nameof(WorkMemoryStorage)].As<RigVMMemoryContainer>(); } set { this["WorkMemoryStorage"] = value; } }
        public RigVMMemoryContainer LiteralMemoryStorage { get { return this[nameof(LiteralMemoryStorage)].As<RigVMMemoryContainer>(); } set { this["LiteralMemoryStorage"] = value; } }
        ...
        public int GetParameterArraySize(Object InParameterName) { return Invoke<int>(nameof(GetParameterArraySize), InParameterName); }
    ...
    public class RigVMStatistics : Object
    {
        ...
        public uint BytesForCDO { get { return this[nameof(BytesForCDO)].GetValue<uint>(); } set { this[nameof(BytesForCDO)].SetValue<uint>(value); } }
        public uint BytesPerInstance { get { return this[nameof(BytesPerInstance)].GetValue<uint>(); } set { this[nameof(BytesPerInstance)].SetValue<uint>(value); } }
        ...
        public uint BytesForCaching { get { return this[nameof(BytesForCaching)].GetValue<uint>(); } set { this[nameof(BytesForCaching)].SetValue<uint>(value); } }
    ...
    public class RigVMByteCodeStatistics : Object
    {
        ...
        public uint InstructionCount { get { return this[nameof(InstructionCount)].GetValue<uint>(); } set { this[nameof(InstructionCount)].SetValue<uint>(value); } }
        public uint DataBytes { get { return this[nameof(DataBytes)].GetValue<uint>(); } set { this[nameof(DataBytes)].SetValue<uint>(value); } }
    }
    public class RigVMMemoryStatistics : Object
    {
        public RigVMMemoryStatistics(nint addr) : base(addr) { }
        public uint RegisterCount { get { return this[nameof(RegisterCount)].GetValue<uint>(); } set { this[nameof(RegisterCount)].SetValue<uint>(value); } }
        public uint DataBytes { get { return this[nameof(DataBytes)].GetValue<uint>(); } set { this[nameof(DataBytes)].SetValue<uint>(value); } }
        public uint TotalBytes { get { return this[nameof(TotalBytes)].GetValue<uint>(); } set { this[nameof(TotalBytes)].SetValue<uint>(value); } }
    }
}
