...
namespace SDK.Script.GameplayCamerasSDK
{
    ...
    {
        public MatineeCameraShake(nint addr) : base(addr) { }
    ...
    {
        public MatineeCameraShakePattern(nint addr) : base(addr) { }
    }
    public class MovieSceneMatineeCameraShakeEvaluator : MovieSceneCameraShakeEvaluator
    {
        public MovieSceneMatineeCameraShakeEvaluator(nint addr) : base(addr) { }
    }
    public class MatineeCameraShakeFunctionLibrary : BlueprintFunctionLibrary
    {
        public MatineeCameraShakeFunctionLibrary(nint addr) : base(addr) { }
