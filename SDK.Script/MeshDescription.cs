...
namespace SDK.Script.MeshDescriptionSDK
{
    ...
    {
        public MeshDescription(nint addr) : base(addr) { }
    }
    public class MeshDescriptionBase : Object
    {
        ...
        public void SetPolygonVertexInstance(PolygonID PolygonID, int PerimeterIndex, VertexInstanceID VertexInstanceID) { Invoke(nameof(SetPolygonVertexInstance), PolygonID, PerimeterIndex, VertexInstanceID); }
        ...
        public void GetVertexVertexInstances(VertexID VertexID, UArray<VertexInstanceID> OutVertexInstanceIDs) { Invoke(nameof(GetVertexVertexInstances), VertexID, OutVertexInstanceIDs); }
        ...
        public void GetVertexInstanceConnectedTriangles(VertexInstanceID VertexInstanceID, UArray<TriangleID> OutConnectedTriangleIDs) { Invoke(nameof(GetVertexInstanceConnectedTriangles), VertexInstanceID, OutConnectedTriangleIDs); }
        ...
        public void GetVertexConnectedTriangles(VertexID VertexID, UArray<TriangleID> OutConnectedTriangleIDs) { Invoke(nameof(GetVertexConnectedTriangles), VertexID, OutConnectedTriangleIDs); }
        ...
        public void GetVertexConnectedEdges(VertexID VertexID, UArray<EdgeID> OutEdgeIDs) { Invoke(nameof(GetVertexConnectedEdges), VertexID, OutEdgeIDs); }
        ...
        public void GetTriangleVertices(TriangleID TriangleID, UArray<VertexID> OutVertexIDs) { Invoke(nameof(GetTriangleVertices), TriangleID, OutVertexIDs); }
        public void GetTriangleVertexInstances(TriangleID TriangleID, UArray<VertexInstanceID> OutVertexInstanceIDs) { Invoke(nameof(GetTriangleVertexInstances), TriangleID, OutVertexInstanceIDs); }
        ...
        public void GetTriangleEdges(TriangleID TriangleID, UArray<EdgeID> OutEdgeIDs) { Invoke(nameof(GetTriangleEdges), TriangleID, OutEdgeIDs); }
        public void GetTriangleAdjacentTriangles(TriangleID TriangleID, UArray<TriangleID> OutTriangleIDs) { Invoke(nameof(GetTriangleAdjacentTriangles), TriangleID, OutTriangleIDs); }
        public void GetPolygonVertices(PolygonID PolygonID, UArray<VertexID> OutVertexIDs) { Invoke(nameof(GetPolygonVertices), PolygonID, OutVertexIDs); }
        public void GetPolygonVertexInstances(PolygonID PolygonID, UArray<VertexInstanceID> OutVertexInstanceIDs) { Invoke(nameof(GetPolygonVertexInstances), PolygonID, OutVertexInstanceIDs); }
        public void GetPolygonTriangles(PolygonID PolygonID, UArray<TriangleID> OutTriangleIDs) { Invoke(nameof(GetPolygonTriangles), PolygonID, OutTriangleIDs); }
        ...
        public void GetPolygonPerimeterEdges(PolygonID PolygonID, UArray<EdgeID> OutEdgeIDs) { Invoke(nameof(GetPolygonPerimeterEdges), PolygonID, OutEdgeIDs); }
        public void GetPolygonInternalEdges(PolygonID PolygonID, UArray<EdgeID> OutEdgeIDs) { Invoke(nameof(GetPolygonInternalEdges), PolygonID, OutEdgeIDs); }
        public void GetPolygonGroupPolygons(PolygonGroupID PolygonGroupID, UArray<PolygonID> OutPolygonIDs) { Invoke(nameof(GetPolygonGroupPolygons), PolygonGroupID, OutPolygonIDs); }
        public void GetPolygonAdjacentPolygons(PolygonID PolygonID, UArray<PolygonID> OutPolygonIDs) { Invoke(nameof(GetPolygonAdjacentPolygons), PolygonID, OutPolygonIDs); }
        ...
        public void GetEdgeVertices(EdgeID EdgeID, UArray<VertexID> OutVertexIDs) { Invoke(nameof(GetEdgeVertices), EdgeID, OutVertexIDs); }
        ...
        public void GetEdgeConnectedTriangles(EdgeID EdgeID, UArray<TriangleID> OutConnectedTriangleIDs) { Invoke(nameof(GetEdgeConnectedTriangles), EdgeID, OutConnectedTriangleIDs); }
        ...
        public void DeleteVertexInstance(VertexInstanceID VertexInstanceID, UArray<VertexID> OrphanedVertices) { Invoke(nameof(DeleteVertexInstance), VertexInstanceID, OrphanedVertices); }
        public void DeleteVertex(VertexID VertexID) { Invoke(nameof(DeleteVertex), VertexID); }
        public void DeleteTriangle(TriangleID TriangleID, UArray<EdgeID> OrphanedEdges, UArray<VertexInstanceID> OrphanedVertexInstances, UArray<PolygonGroupID> OrphanedPolygonGroupsPtr) { Invoke(nameof(DeleteTriangle), TriangleID, OrphanedEdges, OrphanedVertexInstances, OrphanedPolygonGroupsPtr); }
        public void DeletePolygonGroup(PolygonGroupID PolygonGroupID) { Invoke(nameof(DeletePolygonGroup), PolygonGroupID); }
        public void DeletePolygon(PolygonID PolygonID, UArray<EdgeID> OrphanedEdges, UArray<VertexInstanceID> OrphanedVertexInstances, UArray<PolygonGroupID> OrphanedPolygonGroups) { Invoke(nameof(DeletePolygon), PolygonID, OrphanedEdges, OrphanedVertexInstances, OrphanedPolygonGroups); }
        public void DeleteEdge(EdgeID EdgeID, UArray<VertexID> OrphanedVertices) { Invoke(nameof(DeleteEdge), EdgeID, OrphanedVertices); }
        ...
        public void CreateTriangleWithID(TriangleID TriangleID, PolygonGroupID PolygonGroupID, UArray<VertexInstanceID> VertexInstanceIDs, UArray<EdgeID> NewEdgeIDs) { Invoke(nameof(CreateTriangleWithID), TriangleID, PolygonGroupID, VertexInstanceIDs, NewEdgeIDs); }
        public TriangleID CreateTriangle(PolygonGroupID PolygonGroupID, UArray<VertexInstanceID> VertexInstanceIDs, UArray<EdgeID> NewEdgeIDs) { return Invoke<TriangleID>(nameof(CreateTriangle), PolygonGroupID, VertexInstanceIDs, NewEdgeIDs); }
        public void CreatePolygonWithID(PolygonID PolygonID, PolygonGroupID PolygonGroupID, UArray<VertexInstanceID> VertexInstanceIDs, UArray<EdgeID> NewEdgeIDs) { Invoke(nameof(CreatePolygonWithID), PolygonID, PolygonGroupID, VertexInstanceIDs, NewEdgeIDs); }
        ...
        public PolygonID CreatePolygon(PolygonGroupID PolygonGroupID, UArray<VertexInstanceID> VertexInstanceIDs, UArray<EdgeID> NewEdgeIDs) { return Invoke<PolygonID>(nameof(CreatePolygon), PolygonGroupID, VertexInstanceIDs, NewEdgeIDs); }
